...
class Order_model extends CI_Model {
    ...
    public function countOrders($r_id) {
    ...
    public function countPendingOrders($r_id) {
    ...
    public function countDeliveredOrders($r_id) {
    ...
    public function countRejectedOrders($r_id) {
    ...
    public function getAllOrders($r_id) {
        $this->db->order_by('o_id','DESC');
