<div class="container">
    <div class="container shadow-container">
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <?php $status=$order['status']; 
                            if($status=="" or $status=="NULL" or $status=="in process" or $status=="rejected"or $status=="Ready") { ?>
                    <tr>
                        ...
                        <td> <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"
                                    aria-hidden="true"></span> Cooking</button></td>
                        <?php } if($status=="Paid") { ?>
                    ...
                    <?php } ?> <?php if($status=="Ready") { ?>
                        <td> <button type="button" class="btn btn-success"><i class="fa fa-check-circle"></i> Ready To Pick Up</button>
                        </td>
                        <?php } ?>
                        <td><?php echo $order['date']; ?></td>
                        <td>
                            <a href="<?php echo base_url().'shopkeeper/orders/processOrder/'.$order['o_id'];?>"
                                class="btn btn-info mb-1">                               <i class="fas fa-arrow-alt-circle-right"></i> Process</a>
                            <a href="<?php echo base_url().'shopkeeper/orders/deleteOrder/'.$order['o_id']?>"
        ...
        <h2 class="text-center">Transaction Orders</h2>
        <div class="table-responsive-sm">
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td> <button type="button" class="btn btn-success"><i class="fas fa-check"></i> Paid</button>
