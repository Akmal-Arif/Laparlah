...
<body class="bg-white">
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top mb-3">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo base_url().'shopkeeper/home';?>">Shop Panel</a>
            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="<?php echo base_url().'shopkeeper/menu/';?>">Manage Menu</a>
                            <a class="dropdown-item" href="<?php echo base_url().'shopkeeper/menu/create_menu';?>">Create
                                Menu</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="<?php echo base_url().'shopkeeper/orders/';?>"><i class="fas fa-shopping-basket"></i> All Orders</a>
                        </div>
                    </li>
                    <li class="nav-item active">
                        <a href="<?php echo base_url().'shopkeeper/login/logout';?>"
