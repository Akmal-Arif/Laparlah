...
<body>
    <div class="conatiner">
        <h1 class="text-center mt-3">Shopkeeper Panel</h1>
      ...
      ?>
        <form action="<?php echo base_url().'shopkeeper/login/authenticate' ;?>" name="loginform" id="loginform"
            ...
            <p>Don't have an account? <a href="<?php echo base_url().'shopkeeper/signup';?>">Sign Up Now!</a></p>
        </form>
    </div>
    <script>
