            ...
            <table class="table table-striped table-responsive table-hover table-bordered">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php $verification=$store['verification']; 
                            if($verification=="0") { ?>
                            <a href="javascript:void(0);" onclick="verifyStore(<?php echo $store['r_id']; ?>)"
                                class="btn btn-success"><i class="fa fa-check-circle"></i> Verify</a>
                    <?php } ?>
...
function verifyStore(id) {
    if (confirm("Are you sure you want to verify store?")) {
        window.location.href = '<?php echo base_url().'admin/store/verify/';?>' + id;
    }
}
</script>