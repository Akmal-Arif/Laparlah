<div class="container">
    <div class="container shadow-container">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <input class="form-control mb-3" id="myInput" type="text" placeholder="Search .." style="width:60%;">
        </div>
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!--<a href="javascript:void(0);" onclick="verifyuser(<?php echo $user['u_id']; ?>)"
                                class="btn btn-danger"><i class="fas fa-trash-alt"></i>   Verify</a>-->
...
function verifyuser(id) {
    if (confirm("Are you sure you want to verify user?")) {
        window.location.href = '<?php echo base_url().'admin/user/verify/';?>' + id;
    }
}
