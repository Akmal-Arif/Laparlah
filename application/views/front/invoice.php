    ...
    <div class="container my-3" style="border: 2px outset green;">
        ...
        <div class="invoice mb-3">
            <div class="row mb-3 p-3">
                <div class="col-6">
                    <h3 style="color:purple"><b>Laparlah</b></h3>
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <p class="mb-0"><b>Payment Mode:</b> Cash Only</p>
                </div>
                    ...
                    <table class="table responsive">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo 'RM'.$dish['price']; ?></td>
                            </tr>
                            <tr>
                                <td colspan="2"></td>
                                <td class="font-weight-bold">Total</td>
                                <td class="font-weight-bold"><?php echo 'RM'.$order['price'] ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <footer class="text-center">
            ...
            <p>For terms & conditions Please visit www.laparlah.com</p>
        </footer>
    </div>
