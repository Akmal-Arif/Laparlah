    ...
    <div class="wrapper container">
        ...
        <form action="<?php echo base_url().'singup/create_user'; ?>" method="POST" name="myForm" id="myForm"
            ...
            <div class="row">
                ...
                <!--<textarea id="address" name="address" type="number" style="height:70px;" class="form-control
        <?php echo (form_error('address') != "") ? 'is-invalid' : '';?>"
                    value="<?php echo set_value('address');?>"></textarea>
                <?php echo form_error('address'); ?>-->
                <input type="number" class="form-control
                <?php echo (form_error('address') != "") ? 'is-invalid' : '';?>" name="address" placeholder="Contact"
