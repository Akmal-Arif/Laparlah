            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td> <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span> Cooking</button></td>
                        <?php }?>
                        ...
                        <?php } ?>
                        <?php if($status=="Ready") { ?>
                        <td> <button type="button" class="btn btn-success"> <i class="fas fa-check"></i> Ready To Pick Up</button>
                        </td>
                        <?php } ?>
