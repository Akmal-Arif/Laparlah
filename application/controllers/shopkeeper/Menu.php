...
class Menu extends CI_Controller {
    ...
    public function index() {
        ...
        $dishesh = $this->Menu_model->getMenu($shopkeeper['r_id']);
        $data['dishesh'] = $dishesh;
        $this->load->view('shopkeeper/partials/header');
        $this->load->view('shopkeeper/menu/list', $data);
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    redirect(base_url(). 'shopkeeper/menu/index');
                    ...
                    $data['stores']= $store;
                    $this->load->view('shopkeeper/partials/header');
                    $this->load->view('shopkeeper/menu/add_menu', $data);
                    $this->load->view('shopkeeper/partials/footer');
                }
            ...
            $this->load->view('shopkeeper/partials/header');
            $this->load->view('shopkeeper/menu/add_menu', $store_data);
            $this->load->view('shopkeeper/partials/footer');
        }
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $data['stores'] = $store;
                    $this->load->view('shopkeeper/partials/header');
                    $this->load->view('shopkeeper/menu/edit', $data);
                    $this->load->view('shopkeeper/partials/footer');
                }
    ...
    public function delete($id){
        ...
        if(empty($dish)) {
            $this->session->set_flashdata('error', 'dish not found');
            redirect(base_url().'shopkeeper/menu');
        }
